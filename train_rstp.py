...
from datasets import make_dataloader_vl_rstp_level_data as make_dataloader
...
from processor import do_train_rstp_uvt_level_data as do_train
from processor import do_inference_rstp_uvt_base as do_inference
import random
import torch
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config_file", default="configs/RSTPReID/vit_base_uvt_bert.yml", help="path to config file", type=str)
    parser.add_argument("--gpu_id", default="0", type=str)
    parser.add_argument("--dataset", default="rstp_reid", type=str)
    ...
    parser.add_argument("--batch_size", default=48, type=int, help='48')
    parser.add_argument("--data_dir", default="/data/reid/RSTPReid/RSTPReid", type=str)
    parser.add_argument("--logs_dir", default="/logs/20230521_rstp", type=str)
    ...
    train_loader, val_loader, test_loader, num_classes = make_dataloader(cfg)

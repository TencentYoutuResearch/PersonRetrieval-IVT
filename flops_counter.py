...
def get_uvt_complexity_info(model, input_res,
    ...
    _ = flops_model.forward_txt2img(*input_res)
...
def get_sep_complexity_info(model, input_res,
                              print_per_layer_stat=False,
                              as_strings=True,
                              ost=sys.stdout,
                              verbose=False, ignore_modules=[],
    ...
    _ = flops_model.forward_img(input_res[0])
    _ = flops_model.forward_txt(*input_res[1:])

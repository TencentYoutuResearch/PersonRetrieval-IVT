...
from datasets import make_dataloader_vl_cuhk_level_data as make_dataloader
...
from processor import do_train_cuhkpedes_uvt_level_data as do_train
from processor import do_inference_cuhk_uvt_base as do_inference
import random
import torch
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", default="cuhk_pedes_level", type=str)
    ...
    parser.add_argument("--data_dir", default="/data/reid/cuhk_pedes/CUHK-PEDES", type=str)
    parser.add_argument("--logs_dir", default="/logs/20230521_cuhk_gpu", type=str)
    ...
    logger = setup_logger("logger", output_dir, if_train=True)
